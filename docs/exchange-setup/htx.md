...
2. 权限设置中勾选「读取」和「交易」
3. 打开一个合约交易页面，比如 [https://www.htx.com/futures/linear_swap/exchange#contract_code=BTC-USDT&contract_type=swap&type=cross](https://www.htx.com/futures/linear_swap/exchange#contract_code=BTC-USDT&contract_type=swap&type=cross)
4. 点击右上角齿轮按钮，设置「持仓模式」为「单向持仓」
