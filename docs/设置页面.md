...
- 账户信息
    ...
    ![image.png](设置页面说明/image.png)
    
    - 点击 Current Funds 后面数字可以查看资金额详情
- 通知设置
    
    ![image.png](设置页面说明/image%201.png)
...
- 其他设置
    ...
    ![image.png](设置页面说明/image%202.png)
...
- 交易所
    ...
    ![image.png](设置页面说明/image%203.png)
...
- 区块链
    ...
    ![image.png](设置页面说明/image%204.png)
...
- 代币
    ...
    ![image.png](设置页面说明/image%205.png)
