...
Uniswap V3支持的链：[https://docs.uniswap.org/contracts/v3/reference/deployments/](https://docs.uniswap.org/contracts/v3/reference/deployments/)

实际支持的链是Taoli Tools支持的链和Uniswap V3支持的链的交集
...
- 首次交易某个ERC20 Token时候会自动Approve Unlimited给[Uniswap V3 Router合约](https://docs.uniswap.org/contracts/v3/reference/deployments/)。
