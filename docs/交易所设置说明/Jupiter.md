...
5. Enable Exact Out：如果勾选，则在买入的时候使用[ExactOut模式](https://dev.jup.ag/docs/swap-api/payments-through-swap#2-set-swapmode-to-exactout-in-quote)，卖出则始终是 ExactIn 模式。
